...
"""
Gripper-only system launch file.

Launches: Gazebo, MoveIt, RViz, and gripper application nodes.
"""
...
def generate_launch_description():
    """Launch gripper system with full stack."""
    # PACKAGE DIRECTORIES
    ...
    # OBJECT DESCRIPTIONS (CHILD_LINK ONLY)
    ...
    ros_gz_bridge = Node(
        ...
        arguments=[
            ...
            ('/world/default/model/gp25_gripper_system/joint_state'
             '@sensor_msgs/msg/JointState[gz.msgs.Model'),
            f'/model/{child_link_spawn_name}/pose@tf2_msgs/msg/TFMessage[gz.msgs.Pose_V',
        ],
        remappings=[
            ('/world/default/clock', '/clock'),
            ('/world/default/model/gp25_gripper_system/joint_state', '/joint_states'),
    ...
    spawn_robot = Node(
        package='ros_gz_sim',
        executable='create',
        name='spawn_gp25_gripper_system',
        arguments=[
            '-topic', '/robot_description',
            '-name', 'gp25_gripper_system',
            '-allow_renaming', 'true',
            '-x', '0', '-y', '0', '-z', '0',
        ],
        output='screen',
    ...
    # APPLICATION NODES (GRIPPER ONLY)
